        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">Eligibility Check</h1>
                <p className="text-xs text-gray-500">Insurance Verification</p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 px-8 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div className={`h-0.5 w-16 ${currentStep >= 2 ? 'bg-blue-600' : 'bg-gray-200'}`}></div>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  ...
                  <div className="text-center">
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">What patient information do you have?</h2>
                    <p className="text-gray-600">Type the details below or upload insurance documents</p>
                  </div>

                  {/* Simplified Combined Input Area */}
                  <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-200 hover:border-blue-300 transition-all duration-200">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input
                          ...
                          className="w-full px-4 py-3 border-0 bg-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none text-base placeholder-gray-400"
                        />
                        <input
                          type="text"
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          <SearchableDropdown
                            ...
                            placeholder="Month"
                            className="w-full px-3 py-3 border-0 bg-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none text-base placeholder-gray-400"
                          />
                          <SearchableDropdown
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full px-4 py-3 border-0 bg-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none text-base placeholder-gray-400 resize-none"
                      />
                    </div>
                  ...
                  <button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-4 px-6 rounded-xl transition-all duration-200 text-lg"
                  >
                    Check Eligibility
                  </button>
                </div>
              ...
              {currentStep === 2 && (
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">You'll receive eligibility results in 60 minutes</p>
                  </div>
                  ...
                  <div className="max-w-md mx-auto">
                    <input
                      ...
                      className="w-full px-4 py-4 text-center border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-0 transition-all duration-200 text-lg"
                    />
                  </div>

                  {/* Simple Trust Indicator */}
                  <div className="text-center bg-blue-50 rounded-xl p-4 max-w-md mx-auto">
                  ...
                  <div className="flex space-x-3 max-w-md mx-auto">
                    ...
                    <button
                      ...
                      className="flex-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
                    >
                      {isSubmitting ? (
                        <>
                  ...
                  {submitProgress && (
                    <div className="text-center">
                      <div className="inline-flex items-center space-x-2 text-blue-600 bg-blue-50 px-3 py-2 rounded-full text-sm">
