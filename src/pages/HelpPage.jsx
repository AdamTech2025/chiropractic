        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div>
                <h1 className="text-base sm:text-lg font-bold text-gray-900">Help & Support</h1>
                <p className="text-xs text-gray-500 hidden sm:block">Get assistance</p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-6 sm:mb-8">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-100">
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Quick Start Guide</h2>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center">
                    ...
                    <span className="text-base sm:text-lg">Eligibility Check</span>
                  </h3>
                  <ol className="space-y-2 sm:space-y-3 text-sm text-gray-600">
                    <li className="flex items-start">
                      <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">1</span>
                      <span>Enter patient information (name, DOB, member ID, insurance)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">2</span>
                      <span>Upload insurance cards or documents (optional)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">3</span>
                      <span>Provide your email address</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">4</span>
                      <span>Receive results in 3-10 minutes</span>
                    </li>
                  </ol>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-3 sm:mb-4 flex items-center">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 bg-emerald-100 rounded-lg flex items-center justify-center mr-2 sm:mr-3 flex-shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    ...
                    <span className="text-base sm:text-lg">Dental Coding</span>
                  </h3>
                  <ol className="space-y-2 sm:space-y-3 text-sm text-gray-600">
                    <li className="flex items-start">
                      <span className="bg-emerald-100 text-emerald-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">1</span>
                      <span>Describe dental procedures in detail</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-emerald-100 text-emerald-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">2</span>
                      <span>Upload X-rays, treatment plans, or notes (optional)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-emerald-100 text-emerald-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">3</span>
                      <span>Provide your email address</span>
                    </li>
                    <li className="flex items-start">
                      <span className="bg-emerald-100 text-emerald-800 text-xs font-medium px-2 py-1 rounded-full mr-2 sm:mr-3 mt-0.5 flex-shrink-0">4</span>
                      <span>Receive CDT codes within 3-10 minutes</span>
                    </li>
                  </ol>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-green-50 to-teal-50 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-100">
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
                {contactMethods.map((method, index) => (
                  <div key={index} className="text-center">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">{method.title}</h3>
                    <p className="text-xs sm:text-sm text-gray-600 mb-2">{method.description}</p>
                    {method.action ? (
                      <a
                        href={method.action}
                      ...
                      <p className="text-gray-900 font-medium text-sm sm:text-base">{method.contact}</p>
                    )}
                  </div>
                ))}
              </div>
              ...
              <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-gray-200 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl text-sm sm:text-base"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
